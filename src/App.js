...
const tld = '.hunter';
const CONTRACT_ADDRESS = '0x1d82220e00fa462DA60e63438990E8d38b64D81C';
const App = () => {
...
const mintDomain = async () => {
	...
	const renderNotConnectedContainer = () => (
		<div className="connect-wallet-container">
			<img src="https://i.giphy.com/media/xT5LMtRMpzBxi9SzS0/giphy.webp" alt="Hunter gif" />
		...
		<div className="App">
			<div className="container">
				<div className="header-container">
					<header>
						<div className="left">
						<p className="title">🐱‍👤 Hunter Name Service</p>
